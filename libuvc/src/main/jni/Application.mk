...
# Disabled x86 and x86_64 due to PIC compatibility issues with NDK r29
# The assembly files don't support PIC relocation required by modern linkers
APP_ABI :=arm64-v8a armeabi-v7a
#APP_OPTIM := debug
APP_OPTIM := release
# Fix for NDK r29 C++ ABI compatibility
APP_CPPFLAGS += -fno-sized-deallocation
