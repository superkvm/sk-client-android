...
enum libusb_descriptor_type {
	...
	LIBUSB_DT_DEVICE_QUALIFIER = 0x06,				

	
	LIBUSB_DT_OTHER_SPEED_CONFIGURATION = 0x07,		
...
#define LIBUSB_DT_HEADER_SIZE					2	
...
#define LIBUSB_DT_QUALIFER_SIZE					10	
#define LIBUSB_DT_OTHER_SPEED_SIZE				9	
#define LIBUSB_DT_ASSOCIATION_SIZE				8	
...
struct libusb_association_descriptor {	
	uint8_t 	bLength;			
	uint8_t 	bDescriptorType;	
...
libusb_device *libusb_find_device(libusb_context *ctx,
	const int vid, const int pid, const char *sn, int fd);	
...
int LIBUSB_CALL libusb_set_device_fd(libusb_device *dev, int fd);	
