...
struct ParseBoolHandler : BaseReaderHandler<UTF8<>, ParseBoolHandler<expect> > {
    ...
    bool Bool(bool b) { EXPECT_TRUE(expect == b);  ++step_; return true; }
...
#define TEST_DOUBLE(str, x) \
    ...
    TEST_NUMBER(ParseUintHandler, "2147483648", 2147483648u);       
    TEST_NUMBER(ParseUintHandler, "4294967295", 4294967295u);

    TEST_NUMBER(ParseIntHandler, "-123", -123);
    TEST_NUMBER(ParseIntHandler, "-2147483648", -2147483648LL);     

    TEST_NUMBER(ParseUint64Handler, "4294967296", 4294967296ULL);   
    TEST_NUMBER(ParseUint64Handler, "18446744073709551615", 18446744073709551615ULL);   

    TEST_NUMBER(ParseInt64Handler, "-2147483649", -2147483649LL);   
    TEST_NUMBER(ParseInt64Handler, "-9223372036854775808", (-9223372036854775807LL - 1));       
    ...
    TEST_DOUBLE("1e-10000", 0.0);                                   
    TEST_DOUBLE("18446744073709551616", 18446744073709551616.0);    
    TEST_DOUBLE("-9223372036854775809", -9223372036854775809.0);    
...
#define TEST_STRINGARRAY2(Encoding, utype, earray, xarray) \
    ...
    TEST_STRING(UTF8<>, "\x24", "\"\\u0024\"");         
    TEST_STRING(UTF8<>, "\xC2\xA2", "\"\\u00A2\"");     
    TEST_STRING(UTF8<>, "\xE2\x82\xAC", "\"\\u20AC\""); 
    TEST_STRING(UTF8<>, "\xF0\x9D\x84\x9E", "\"\\uD834\\uDD1E\"");  
    ...
    TEST_STRINGARRAY(UTF16<>, wchar_t, ARRAY(0x00A2, 0x0000), L"\"\\u00A2\"");  
    TEST_STRINGARRAY(UTF16<>, wchar_t, ARRAY(0x20AC, 0x0000), L"\"\\u20AC\"");  
    TEST_STRINGARRAY(UTF16<>, wchar_t, ARRAY(0xD834, 0xDD1E, 0x0000), L"\"\\uD834\\uDD1E\"");   
    ...
    TEST_STRINGARRAY2(UTF32<>, unsigned, ARRAY(0x000A2, 0x0000), ARRAY('\"', '\\', 'u', '0', '0', 'A', '2', '\"', '\0'));   
    TEST_STRINGARRAY2(UTF32<>, unsigned, ARRAY(0x020AC, 0x0000), ARRAY('\"', '\\', 'u', '2', '0', 'A', 'C', '\"', '\0'));   
    TEST_STRINGARRAY2(UTF32<>, unsigned, ARRAY(0x1D11E, 0x0000), ARRAY('\"', '\\', 'u', 'D', '8', '3', '4', '\\', 'u', 'D', 'D', '1', 'E', '\"', '\0'));    
